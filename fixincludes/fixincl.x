 ...
 *
 * It has been AutoGen-ed  September 30, 2020 at 03:05:24 PM by AutoGen 5.18.12
 * From the definitions    inclhack.def
 * and the template file   fixincl
 */
/* DO NOT SVN-MERGE THIS FILE, EITHER Wed Sep 30 15:05:24 UTC 2020
 *
...
/* * * * * * * * * * * * * * * * * * * * * * * * * *
 *
 *  Description of Vxworks_Time_H_Needs_Syslib fix
 */
tSCC zVxworks_Time_H_Needs_SyslibName[] =
     "vxworks_time_h_needs_sysLib";

/*
 *  File name selection pattern
 */
tSCC zVxworks_Time_H_Needs_SyslibList[] =
  "time.h\0";
/*
 *  Machine/OS name selection pattern
 */
tSCC* apzVxworks_Time_H_Needs_SyslibMachs[] = {
        "*-*-vxworks*",
        (const char*)NULL };
#define VXWORKS_TIME_H_NEEDS_SYSLIB_TEST_CT  0
#define aVxworks_Time_H_Needs_SyslibTests   (tTestDesc*)NULL

/*
 *  Fix Command Arguments for Vxworks_Time_H_Needs_Syslib
 */
static const char* apzVxworks_Time_H_Needs_SyslibPatch[] = { sed_cmd_z,
    "-e", "s@#endif .* _YVALS .*@#endif\\\n\
#include <sysLib.h>@",
    "-e", "s@#include <objLib.h>@#include <objLib.h>\\\n\
#include <sysLib.h>@",
    (char*)NULL };
...
/* * * * * * * * * * * * * * * * * * * * * * * * * *
 *
 *  Description of Vxworks_Yvals fix
 */
tSCC zVxworks_YvalsName[] =
     "vxworks_yvals";

/*
 *  File name selection pattern
 */
tSCC zVxworks_YvalsList[] =
  "yvals.h\0";
/*
 *  Machine/OS name selection pattern
 */
tSCC* apzVxworks_YvalsMachs[] = {
        "*-*-vxworks*",
        (const char*)NULL };
 ...
 *  content selection pattern - do fix if pattern found
 */
tSCC zVxworks_YvalsSelect0[] =
       "include_next <yvals.h>";

#define    VXWORKS_YVALS_TEST_CT  1
static tTestDesc aVxworks_YvalsTests[] = {
  { TT_EGREP,    zVxworks_YvalsSelect0, (regex_t*)NULL }, };

/*
 *  Fix Command Arguments for Vxworks_Yvals
 */
static const char* apzVxworks_YvalsPatch[] = { sed_cmd_z,
    "-e", "s/#if (defined(__cplusplus) && defined(__GNUC__))/#if 0/",
    (char*)NULL };

/* * * * * * * * * * * * * * * * * * * * * * * * * *
 *
 *  Description of Vxworks_Extern_Cxx fix
 */
tSCC zVxworks_Extern_CxxName[] =
     "vxworks_extern_cxx";

/*
 *  File name selection pattern
 */
tSCC zVxworks_Extern_CxxList[] =
  "inttypes.h\0complex.h\0math.h\0";
/*
 *  Machine/OS name selection pattern
 */
tSCC* apzVxworks_Extern_CxxMachs[] = {
        "*-*-vxworks*",
        (const char*)NULL };
 ...
 *  content bypass pattern - skip fix if pattern found
 */
tSCC zVxworks_Extern_CxxBypass0[] =
       "extern \"C++\"";

#define    VXWORKS_EXTERN_CXX_TEST_CT  1
static tTestDesc aVxworks_Extern_CxxTests[] = {
  { TT_NEGREP,   zVxworks_Extern_CxxBypass0, (regex_t*)NULL }, };

/*
 *  Fix Command Arguments for Vxworks_Extern_Cxx
 */
static const char* apzVxworks_Extern_CxxPatch[] = { sed_cmd_z,
    "-e", "/^#ifdef __cplusplus$/,/^#endif .[*] __cplusplus .[*]$/{s/#ifdef[ \t]__cplusplus$/\\0\\nextern \"C++\" {/;t f;s/^#endif .* __cplusplus .*$/}\\n\\0/;:f}",
    "-e", "/^[ \t]*#if defined(__cplusplus).*$/,/^[ \t]*#else [/][*] defined(__cplusplus) .* [*][/]$/{s/^[ \t]*#if defined(__cplusplus).*$/\\0\\nextern \"C++\" {/;t f;s/^[ \t]*#else [/][*] defined(__cplusplus) .* [*][/]$/}\\n\\0/;:f}",
    "-e", "s/#define _FPCOMP_template.*/#define _FPCOMP_template defined(__cplusplus)/",
    "-e", "/^ *#if _FPCOMP_template$/,/^ *#else \\/\\* _FPCOMP_template \\*\\/$/{$!{ N;  s/^ *#if _FPCOMP_template\\n\\(\\s*\\/\\/.*\\)$/\\0\\nextern \"C++\" {\\nnamespace std {\\n\\1/;  t done;  s/^ *#else \\/\\* _FPCOMP_template \\*\\/\\n.*$/}\\n}\\n\\0/;  t done;  P;D;:done}}",
    "-e", "/^ *#if _HAS_C9X_IMAGINARY_TYPE$/,/^ *#endif \\/\\* _HAS_C9X_IMAGINARY_TYPE \\*\\//{s/^ *#if _HAS_C9X_IMAGINARY_TYPE$/#ifndef __cplusplus\\n\\0/;s/^ *#endif \\/\\* _HAS_C9X_IMAGINARY_TYPE \\*\\//\\0\\n#endif \\/* __cplusplus *\\//}",
    (char*)NULL };

/* * * * * * * * * * * * * * * * * * * * * * * * * *
 *
 *  Description of Vxworks_Math_H_Missing_C99 fix
 */
tSCC zVxworks_Math_H_Missing_C99Name[] =
     "vxworks_math_h_missing_c99";

/*
 *  File name selection pattern
 */
tSCC zVxworks_Math_H_Missing_C99List[] =
  "math.h\0";
/*
 *  Machine/OS name selection pattern
 */
tSCC* apzVxworks_Math_H_Missing_C99Machs[] = {
        "*-*-vxworks*",
        (const char*)NULL };
 ...
 *  content selection pattern - do fix if pattern found
 */
tSCC zVxworks_Math_H_Missing_C99Select0[] =
       " *// FUNCTION signbit";

/*
 *  content bypass pattern - skip fix if pattern found
 */
tSCC zVxworks_Math_H_Missing_C99Bypass0[] =
       "bool isfinite(float _Left)";

#define    VXWORKS_MATH_H_MISSING_C99_TEST_CT  2
static tTestDesc aVxworks_Math_H_Missing_C99Tests[] = {
  { TT_NEGREP,   zVxworks_Math_H_Missing_C99Bypass0, (regex_t*)NULL },
  { TT_EGREP,    zVxworks_Math_H_Missing_C99Select0, (regex_t*)NULL }, };

/*
 *  Fix Command Arguments for Vxworks_Math_H_Missing_C99
 */
static const char* apzVxworks_Math_H_Missing_C99Patch[] = {
    "format",
    "inline bool isfinite(float _Left)\n\
        {\n\
\treturn (_FDtest(&_Left) <= 0);\n\
        }\n\
inline bool isfinite(double _Left)\n\
        {\n\
\treturn (_Dtest(&_Left) <= 0);\n\
        }\n\
inline bool isfinite(long double _Left)\n\
        {\n\
\treturn (_LDtest(&_Left) <= 0);\n\
        }\n\
inline bool isinf(float _Left)\n\
        {\n\
\treturn (_FDtest(&_Left) == FP_INFINITE);\n\
        }\n\
inline bool isinf(double _Left)\n\
        {\n\
\treturn (_Dtest(&_Left) == FP_INFINITE);\n\
        }\n\
inline bool isinf(long double _Left)\n\
        {\n\
\treturn (_LDtest(&_Left) == FP_INFINITE);\n\
        }\n\
inline bool isnan(float _Left)\n\
        {\n\
\treturn (_FDtest(&_Left) == FP_NAN);\n\
        }\n\
inline bool isnan(long double _Left)\n\
        {\n\
\treturn (_LDtest(&_Left) == FP_NAN);\n\
        }\n\
inline bool isnormal(float _Left)\n\
        {\n\
\treturn (_FDtest(&_Left) == FP_NORMAL);\n\
        }\n\
inline bool isnormal(long double _Left)\n\
        {\n\
\treturn (_LDtest(&_Left) == FP_NORMAL);\n\
        }\n\n\
%0\n",
    (char*)NULL };
...
typedef enum {
    ...
    VXWORKS_TIME_H_NEEDS_SYSLIB_FIXIDX,
    VXWORKS_NEEDS_VXWORKS_FIXIDX,
    VXWORKS_REGS_FIXIDX,
    VXWORKS_POSIX_MKDIR_FIXIDX,
    VXWORKS_POSIX_OPEN_FIXIDX,
    VXWORKS_YVALS_FIXIDX,
    VXWORKS_EXTERN_CXX_FIXIDX,
    VXWORKS_MATH_H_MISSING_C99_FIXIDX,
    VXWORKS_TIME_FIXIDX,
...
tFixDesc fixDescList[ FIX_COUNT ] = {
  ...
  {  zVxworks_Time_H_Needs_SyslibName,    zVxworks_Time_H_Needs_SyslibList,
     apzVxworks_Time_H_Needs_SyslibMachs,
     VXWORKS_TIME_H_NEEDS_SYSLIB_TEST_CT, FD_MACH_ONLY,
     aVxworks_Time_H_Needs_SyslibTests,   apzVxworks_Time_H_Needs_SyslibPatch, 0 },
  ...
  {  zVxworks_YvalsName,    zVxworks_YvalsList,
     apzVxworks_YvalsMachs,
     VXWORKS_YVALS_TEST_CT, FD_MACH_ONLY,
     aVxworks_YvalsTests,   apzVxworks_YvalsPatch, 0 },

  {  zVxworks_Extern_CxxName,    zVxworks_Extern_CxxList,
     apzVxworks_Extern_CxxMachs,
     VXWORKS_EXTERN_CXX_TEST_CT, FD_MACH_ONLY,
     aVxworks_Extern_CxxTests,   apzVxworks_Extern_CxxPatch, 0 },

  {  zVxworks_Math_H_Missing_C99Name,    zVxworks_Math_H_Missing_C99List,
     apzVxworks_Math_H_Missing_C99Machs,
     VXWORKS_MATH_H_MISSING_C99_TEST_CT, FD_MACH_ONLY | FD_SUBROUTINE,
     aVxworks_Math_H_Missing_C99Tests,   apzVxworks_Math_H_Missing_C99Patch, 0 },
