...
package body Bindgen is
   ...
   --     XDR_Stream                    : Integer;
   --     Unix_Time_T_is_32_Bits        : Integer;
   ...
   --  Unix_Time_T_is_32_Bits indicates that time_t is 32 bits and will
   ...
   begin
      ...
      --  used by the run time.
         ...
         if Unix_Time_T_is_32_Bits then
            WBI ("      Unix_Time_T_is_32_Bits : Integer;");
            WBI ("      pragma Import (C, Unix_Time_T_is_32_Bits, " &
                 """__gl_time_t_is_32_bits"");");
         end if;
