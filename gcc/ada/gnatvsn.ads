...
package Gnatvsn is
   ...
   Gnat_Static_Version_String : constant String := "2021 (20210519)";
   ...
   Library_Version : constant String := "2021";
   ...
   type Gnat_Build_Type is (Gnatpro, Gnatpro_Devel, Gnatpro_Tegra, FSF, GPL);
   ...
   --
   --    Gnatpro
   --       GNAT Professional version (Enterprise and Assurance). This version
   --       of GNAT is supported by AdaCore. The bug box generated by package
   --       Comperr gives instructions on bug submission that include
   --       references to customer number, gnattracker site, etc.
   --
   --    Gnatpro_Devel
   --       GNAT Pro Developer version. Similar to Gnatpro, except for the
   --       version number.
   --
   --    Gnatpro_Tegra
   --       GNAT Pro Tegra version. Similar to Gnatpro, except for the
   --       version number.
   --
   --    GPL
