...
private
   function C_Sqrt  (X    : Long_Long_Float) return Long_Long_Float;
   function C_Log   (X    : Long_Long_Float) return Long_Long_Float;
   function C_Exp   (X    : Long_Long_Float) return Long_Long_Float;
   function C_Pow   (X, Y : Long_Long_Float) return Long_Long_Float;
   function C_Sin   (X    : Long_Long_Float) return Long_Long_Float;
   function C_Cos   (X    : Long_Long_Float) return Long_Long_Float;
   function C_Tan   (X    : Long_Long_Float) return Long_Long_Float;
   function C_Asin  (X    : Long_Long_Float) return Long_Long_Float;
   function C_Acos  (X    : Long_Long_Float) return Long_Long_Float;
   function C_Atan2 (Y, X : Long_Long_Float) return Long_Long_Float;
   ...
   package CMI is new System.Generic_C_Math_Interface (Long_Long_Float);
