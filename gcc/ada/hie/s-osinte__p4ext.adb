...
--  This is the Ravenscar version of this package for PikeOS - p4ext API
...
package body System.OS_Interface is
   ...
   pragma Import (C, p4_my_uid, "__gnat_p4_my_uid");
   ...
   pragma Import (C, p4_fast_set_prio, "__gnat_p4_fast_set_prio");
   ...
   is
      ...
      function Gnat_p4ext_thread_create
        (Prio       : P4_prio_t;
         Code       : Address;
         Arg        : Address;
         Stack      : Address;
         Stack_Size : System.Parameters.Size_Type) return P4_e_t;
      pragma Import (C, Gnat_p4ext_thread_create,
                     "__gnat_p4ext_thread_create");
   ...
   begin
      ...
      Status := Gnat_p4ext_thread_create
        (P4_prio_t (Priority), Code, Arg, Stack_Address, Stack_Size);
