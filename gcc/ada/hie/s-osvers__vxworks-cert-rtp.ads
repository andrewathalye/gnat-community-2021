...
--  This is the VxWorks Cert 6 RTP version of this file. If you add an OS
--  please be sure to update type OS_Version in all variants of this file,
...
package System.OS_Versions is
   ...
   OS : constant OS_Version := VxWorks_Cert_RTP;
