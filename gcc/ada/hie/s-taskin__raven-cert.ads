...
package System.Tasking is
   ...
   type Common_ATCB is record
      ...
      --  Current priority. Used only by LynxOS-178.
      --
      --  Protection: Only written by Self, accessed by anyone
      ...
      --  is going to awake it. Used in s-taprop-raven-cert-lynxos178.adb.
      --
      --  Protection: Common.LL.L.

      Task_Arg : System.Address;
      --  The argument to task procedure. Currently unused; this will provide a
      --  handle for discriminant information.
      --
      ...
      Compiler_Data : aliased System.Soft_Links.TSD;
      ...
      --  System-specific attributes of the task as specified by the Task_Info
      --  pragma.
   end record;
   ...
   --  this only with abort deferred and holding All_Tasks_L.
