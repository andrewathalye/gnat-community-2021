...
--  This is the System.Traceback_Control implementation for most bareboard
--  targets.
...
package body System.Traceback_Control is
   ...
   function Return_Address_Offset return System.Address is
      ...
      --  The return address slot is located right past the 4bytes back-chain
      --  link in a frame:
      Return_Address_Slot_Offset : constant := System.Address'Size / 8;
