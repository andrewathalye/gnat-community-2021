...
--  This version of System is a generic version suitable for use with a target
--  configuration file (-gnateT switch), for generating C code.
...
--  The secondary stack mechanism is not supported
