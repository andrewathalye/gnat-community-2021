...
--  Level A certifiable LynxOS-178 version
...
package System is
   ...
   --  LLF is 80 bits on x86 and not fully supported in Lynx178 so
   --  change to LF to yield Annex G compliance.
   ...
   --  Note: the priority of the environment task is set externally by the OS
