...
--                                                                          --
--                                 S p e c                                  --
--                  (VxWorks7/HIE Version AARCH64 Kernel)                   --
--                                                                          --
...
private
   ...
   --  We can't use a spec file here because -nostdlib needs to
   --  to be read by vxlink which currently doesn't grok spec files.
