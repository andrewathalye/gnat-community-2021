...
#undef clamp
  ...
  *pfilename = this_input_filename
  ...
  /* If dumping SCOs, make sure the lexer preserves sane column numbers with
     line directives for token system-ness.  */
  if (flag_dump_scos)
    cpp_opts->preserve_system_token_columnno = true;
