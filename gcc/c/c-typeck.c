...
/* This is the entry point used by the parser to build binary operators
   ...
   LOCATION is the location of the binary operator. LOC1 and LOC2 are the
   locations for the two operands (respectively ARG1 and ARG2).  */
...
build_binary_op_with_locs (location_t location, enum tree_code code,
			   ...
			   tree orig_op1, location_t op1_loc,
			   bool convert_p)
{
