...
(define_insn "*movdi_internal32_basic"
  [(set (match_operand:DI 0 "nonimmediate_operand" "=Y,r,r,?m,?*d,?*d,r")
	(match_operand:DI 1 "input_operand" "r,Y,r,d,m,d,IJKnF"))]
  "!TARGET_POWERPC64
   && TARGET_AVOID_FPU_FOR_INT_MOVES
   && (gpc_reg_operand (operands[0], DImode)
       || gpc_reg_operand (operands[1], DImode))"
...
(define_insn "*movdi_internal64_basic"
  [(set (match_operand:DI 0 "nonimmediate_operand" "=YZ,r,r,r,r,r,r,?m,?*d,?*d,r,*h,*h")
	(match_operand:DI 1 "input_operand" "r,YZ,r,I,L,eI,nF,d,m,d,*h,r,0"))]
  "TARGET_POWERPC64
   && TARGET_AVOID_FPU_FOR_INT_MOVES
   && (gpc_reg_operand (operands[0], DImode)
       || gpc_reg_operand (operands[1], DImode))"
  "@
   ...
   mt%0 %1
   nop"
  [(set_attr "type" "store,load,*,*,*,*,*,fpstore,fpload,fpsimple,mfjmpr,mtjmpr,*")
   (set_attr "size" "64")
   (set_attr "length" "*,*,*,*,*,*,20,*,*,*,*,*,*")])
