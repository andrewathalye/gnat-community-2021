...
/* Dwarf2 unwind info is supported, unless overriden by a request for a target
   ...
   redefinitions in the former.  Also set DWARF2_UNWIND_INFO to 0 in order
   to make sure a definition is always provided and to prevent
   gcc/defaults.h from picking a possibly different one.  */
