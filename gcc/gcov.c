...
main (int argc, char **argv)
{
  ...
  if (strstr (version_string, "GNAT Pro") != NULL
      && getenv ("ENABLE_GCOV") == NULL)
    {
      fnotice (stderr,
	       "gcov is no longer supported and will be eventually removed "
               "from GNAT Pro,\n");
      fnotice (stderr, "consider using gnatcoverage instead.\n");
      fnotice (stderr,
               "Set the environment variable ENABLE_GCOV to continue "
               "using gcov in the meantime.\n");
