	  ...
	  if (!gimple_plf (stmt, STMT_NECESSARY))
	      ...
	      if (!is_gimple_debug (stmt))
		{
		  if (last_location == UNKNOWN_LOCATION
		      && useful_location_p (cfun, gimple_location (stmt)))
...
const pass_data pass_data_dce_O0 =
{
  GIMPLE_PASS, /* type */
  "dce0", /* name */
  OPTGROUP_NONE, /* optinfo_flags */
...
class pass_dce_O0 : public gimple_opt_pass
{
public:
  pass_dce_O0 (gcc::context *ctxt)
    : gimple_opt_pass (pass_data_dce_O0, ctxt)
  {}

  /* opt_pass methods: */
  opt_pass * clone () { return new pass_dce_O0 (m_ctxt); }
  virtual bool gate (function *) { return !optimize && flag_tree_dce != 0; }
  virtual unsigned int execute (function *) { return tree_ssa_dce (); }
...
gimple_opt_pass *
make_pass_dce_O0 (gcc::context *ctxt)
{
  return new pass_dce_O0 (ctxt);
}
